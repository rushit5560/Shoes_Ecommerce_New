...
class FeaturedProductData {
  ...
  bool success;
  List<FeaturedProductDetails> data;
  String message;

  factory FeaturedProductData.fromJson(Map<String, dynamic> json) => FeaturedProductData(
    success: json["success"],
    data: List<FeaturedProductDetails>.from(json["data"].map((x) => FeaturedProductDetails.fromJson(x))),
...
class FeaturedProductDetails {
  ...
  factory FeaturedProductDetails.fromJson(Map<String, dynamic> json) => FeaturedProductDetails(
    id: json["id"],
